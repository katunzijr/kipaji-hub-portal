          ...
          <form className="space-y-6 text-gray-600">
            ...
            <div>
              ...
              <select
                id="userType"
                name="userType"
                className="block w-full px-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none transition-colors"
              >
                ...
                <option value="fan">Fan / Music Enthusiast</option>
              </select>
            </div>
